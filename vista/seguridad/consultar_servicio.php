        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="nombreser" class="form-control" id="cam_nombreser" style="width:250px; height:35px" required maxlength="30" value="<?php echo $laServicio[1];?>" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="enlaceser" class="form-control" id="cam_enlaceser" style="width:300px; height:35px" maxlength="50" required value="<?php echo $laServicio[2];?>">
                </div>
            </div>
        </div>
         <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="idmodulo" class="form-control" id="cam_idmodulo" style="width:200px; height:35px" required>
