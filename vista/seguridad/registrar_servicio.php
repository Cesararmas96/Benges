    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="nombreser" class="form-control" id="cam_nombreser" maxlength="25" style="width:250px; height:35px" required/>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="enlaceser" class="form-control" id="cam_enlaceser" style="width:300px; height:35px" maxlength="50" required/>
            </div>
        </div>
    </div>
     <div class="row">
