...
* @version    v1.0
*/-->
<h1 class="page-header">Registrar Modulo</h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input class="form-control" type="text" style="width:200px; height:35px" maxlength="30" name="nombremod" id="cam_nombremod" required/>
            </div>
        </div>
    </div>
    <div class="row">
