...
<form class="formulario" action="../controlador/control_asignacion.php" method="POST" name="form_asignacion" >
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="apellidodosper" readonly="readonly"  id="cam_apellidodosper" onkeyup="this.value=this.value.replace(solo_letras, '')" />
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="form-group">
                <label for="cam_idtdepartamento">Departamento Ubicado<span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="No ingrese puntos (.) ni comas (,)."><i class="fa fa-question" ></i></span></label>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="form-group">
                <label for="cam_idtdepartamento">Departamento Destinado<span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="No ingrese puntos (.) ni comas (,)."><i class="fa fa-question" ></i></span></label>
