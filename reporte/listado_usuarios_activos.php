<?php
   ...
   */
   ...
   $listado_usuario=$lobjUsuario->listar_usuario_activos();
   ob_end_clean();
   ...
   $lobjPdf->Cell(0,6,utf8_decode("Listado Total de Usuarios Activos"),0,1,"C");
   $lobjPdf->ln(4);
   ...
   $lobjPdf->Output('I','listado de usuarios activos.pdf');
