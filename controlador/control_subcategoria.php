...
$nom=$_POST['nombresubcat'];
	...
	switch ($operacion) 
	{
		...
		if($lobjSubcategoria->consultar_subcategoria_nom($nom))
		{
			header('location: ../vista/intranet.php?vista=subcategoria/registrar_subcategoria&datos=existe');
		}
		else{
		...
		if($lobjSubcategoria->consultar_subcategoria_nom($nom))
		{
			header('location: ../vista/intranet.php?vista=subcategoria/consultar_subcategoria&datos=existe');
		}
		else{
